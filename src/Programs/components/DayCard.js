                ...
                <Col>
                  <Table className="text-white">
                    ...
                    <tbody>
                      <tr>
                        <td>
                        {this.state.user.roles[0].name === "ROLE_COACH"? <></>:this.state.status == "completed"? <></>:  <input
                            type="checkbox"
                            className="form-check-​input"
                            onChange={this.handleCheck.bind(this)}
                          ></input>}{" "}
                         <strong className="border-bottom">Breakfast</strong> : {this.props.program.breakfast} <br />
                        </td>
                      </tr>
                      <tr>
                        <td>
                        {this.state.user.roles[0].name === "ROLE_COACH"? <></>:this.state.status == "completed"? <></>: <input
                            ...
                            onChange={this.handleCheck.bind(this)}
                          ></input>}{" "}
                           <strong className="border-bottom">Lunch</strong> : {this.props.program.lunch} <br />
                        </td>
                      </tr>
                      <tr>
                        <td>
                        {this.state.user.roles[0].name === "ROLE_COACH"? <></>:this.state.status == "completed"? <></>:  <input
                            ...
                            onChange={this.handleCheck.bind(this)}
                          ></input>}
                           <strong className="border-bottom">Dinner</strong> : {this.props.program.dinner} <br />
                        </td>
                      </tr>
                      <tr>
                        <td>
                        {this.state.user.roles[0].name === "ROLE_COACH"? <></>:this.state.status == "completed"? <></>:  <input
                            ...
                            onChange={this.handleCheck.bind(this)}
                          ></input>}
                           <strong className="border-bottom">Extra</strong> :
                      ...
                      <tr>
                        <td>
                          ...
                          {this.state.user.roles[0].name === "ROLE_COACH"? <></>:this.state.status == "completed"? <></>:  <input
                            ...
                            onChange={this.handleCheck.bind(this)}
                          ></input>}
                         <strong className="border-bottom">Water</strong> : {this.props.program.waterQuantity} L
                        </td>
                      </tr>
                    </tbody>
                  </Table>
                    ...
                    <tbody>
                      <tr>
                        ...
                        {this.state.user.roles[0].name === "ROLE_COACH"? <></>:this.state.status == "completed"? <></>:<>  <input
                          ...
                          <br />
                          <VideoPlayer
                            id={this.props.program.videos.fileId}
