    ...
    render() {
        ...
        return (
            ...
            <div className="topCoaches Container mr-auto">
                ...
                <div className="topcoach w-25"><img className="rounded-circle"src="Coach.jpeg" style={picStyle}></img></div>
                <div className="topcoach w-75"><img className="rounded-circle"src="Coach.jpeg" style={picStyle}></img></div>
