...
handleRate(i){
  console.log("checked");
  console.log(this.state.checkedRate);
i==1??
  this.setState({
    checkedRate: !this.state.checkedRate,
  });
    ...
    return (
      <div>
        ...
        <IconCheckbox checked={this.state.checkedRate} 
                      checkedIcon={ <FontAwesome className="fa-star text-warning"  />} 
                      uncheckedIcon={ <FontAwesome className="fa-star" />} 
                      iconContainerClassName="text-warning"
