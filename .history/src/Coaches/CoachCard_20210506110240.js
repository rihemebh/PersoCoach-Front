      ...
      <Col height="auto">
        <Card className="rounded" style={{ height: "275px", width: "183px" }}>
          ...
          <CardBody>
            ...
            <CardText> <Container> <Row> {rate}  <ReviewModal reviews={this.state.reviews} ></ReviewModal> </Row></Container></CardText>
           
            <CardText></CardText><small>{this.props.type} Coach</small>
          </CardBody>
          <CardFooter>
            <a
