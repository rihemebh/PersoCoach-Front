    ...
    render() {
     ...
     for (let i = 0; i < 5; i++) {
        ...
        return (
         ...
         <CardFooter>
        <small>{this.props.type} Coach
          <a href={'/coach/'+ this.state.id} tag={Link} className="btn-link mr-1 btn text-center text-danger" style={{textDecoration: "underline"}}>
             <small>See More</small></a> </small></CardFooter>                     
    </Card>
