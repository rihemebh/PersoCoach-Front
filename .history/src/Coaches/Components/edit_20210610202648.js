...
import Experience from "src\Coaches\Components\Experience.js"
     ...
     <>
         <AvForm
              ...
              <hr></hr>
               ...
               <Experience /> : <Button className="btn-round" onClick={()=>{this.setState({experience: true})}} style={{marginTop: "20px",marginLeft: "0px"}} > 
