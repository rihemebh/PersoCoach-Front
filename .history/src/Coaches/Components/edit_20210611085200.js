...
export default class Edit extends Component {
  ...
  {works}
  <Button className="btn-round" onClick={this.addWork} style={{marginTop: "20px",marginLeft: "0px"}} > 
<FontAwesome className="fas fa-plus"></FontAwesome> Add another work </Button>
