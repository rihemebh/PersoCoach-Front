...
var id = axios.put("http://localhost:3000/api/program/add", detailedProgram).then(function (response) {
 // const notify = () => toast.success("Your day program was successfully added !");
 // notify();
  //var button = document.getElementById(this.state.id);
  //console.log(response.data);
 this.setState({id : response.data},()=>console.log(this.state.progId));
            ...
            <>
              ...
              <td>
                <Link
                  ...
                  to={{ pathname: "/program", request: request , id : this.state.id}}
                >
