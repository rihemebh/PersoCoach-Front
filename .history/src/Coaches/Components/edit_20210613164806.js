        ...
        >
          ...
          <div className="form-inline ">
            ...
            <FormGroup>
              <h6>
                Gender
                <AvField type="select" name="gender" id="select" onChange={(e)=>this.setState({gender : e.target.value})}>
                  <option value="none"  hidden >{this.state.gender== "Man" ? "Male" : "Female"}</option>
