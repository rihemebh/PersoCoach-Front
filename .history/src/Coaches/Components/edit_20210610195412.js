     ...
     <>
         <AvForm
              ...
              <h5></h5>
               ...
               <h6 className="">
                   Email 
               <AvField  name="breakfast"className="" type="email" label="" required style={{marginTop: "3px", marginRight: "20px"}}/>
                    ...
                    <h6 className=""  >
                    Password 
                      <AvField  name="lunch" className="c"  type="password" label="" required style={{marginTop: "3px", marginRight: "20px"}} />
                      </h6>
                 <hr></hr>
