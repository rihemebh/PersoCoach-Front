...
export default class Details extends React.Component {
  ...
  componentDidMount(){
    ...
    axios.get("http://localhost:8080/api/bprogram/request",this.state.request).then(function(response){
        this.setState({program : response.data.value});
...
const API_URL_USER = "http://localhost:8080/api/user/";
   ...
   render() {
       const program = this.state.program[0];
