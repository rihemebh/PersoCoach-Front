...
export default class Edit extends Component {
  ...
  nbExp(){
    this.props.add(this.state.nb+1);
}
  render() {
   var experiences = [];
              ...
              <hr></hr>
               ...
               <AvField  name="name"className="" type="text" label=""  style={{marginTop: "3px", marginRight: "20px"}}/>
                   ...
                   Description 
                     ...
                     <Button className="btn-round" onClick={()=>{this.setState({experience: 1})}} style={{marginTop: "20px",marginLeft: "0px"}} > 
                      <FontAwesome className="fas fa-plus"></FontAwesome> </Button>: {experiences}}
