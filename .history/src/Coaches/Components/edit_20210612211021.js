...
export default class Edit extends Component {
  ...
  const gender = document.getElementById('select').options.length == 0 ? this.state.gender : values.gender ;
        ...
        >
          ...
          <div className="form-inline ">
            ...
            <FormGroup>
              <h6>
                Gender
                <AvField type="select" name="gender" id="select">
                  <option value="none"  hidden >-- Not selected --</option>
