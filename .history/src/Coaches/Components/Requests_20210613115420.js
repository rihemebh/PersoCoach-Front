...
{ 
  ...
  <ProgramModal  request={request} coach={request.coach} client={request.client} />
  </td></>:request.status == "Waiting for response" ?<><td className="text-warning">Waiting for response</td><td>
    <Details request={request} />
    </td></>: request.status == "accepted" ?<><td className="text-success">Accepted</td>
    <td>
  <Link className="text-secondary" to={{pathname: "/program",
aboutProps}} > 
  
  <Button  color="link" ><u> Send A Detailed Program</u></Button></Link>
