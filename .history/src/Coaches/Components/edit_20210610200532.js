         ...
         <AvForm
              ...
              <hr></hr>
               ...
               <AvField  name="name"className="" type="text" label="" required style={{marginTop: "3px", marginRight: "20px"}}/>
                    ...
                    <h6 className=""  >
                    Coche type 
                      <AvField  name="type" className="c"  type="text" label="" required style={{marginTop: "3px", marginRight: "20px"}} />
                      </h6>
                      <h6 className=""  >
                    Coche type 
                      <AvField  name="type" className="c"  type="select" label="" required style={{marginTop: "3px", marginRight: "20px"}} />
                      </h6>
