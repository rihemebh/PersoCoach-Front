     ...
     <>
         <AvForm
              ...
              <hr></hr>
               ...
               <h6 className="">
                   Email 
               <AvField  name="email"className="" type="email" label=""  style={{marginTop: "3px", marginRight: "20px"}}/>
               ...
               <h6 className="">
                   Full Name 
               <AvField  name="name"className="" type="text" label="" requred style={{marginTop: "3px", marginRight: "20px"}}/>
               ...
               <Experience exp={this.han} /> : <Button className="btn-round" onClick={()=>{this.setState({experience: true})}} style={{marginTop: "20px",marginLeft: "0px"}} > 
