...
return rows });
    ...
    return (
     ...
     <br></br>
     <br></br>
     <button className="text-secondary btn btn-link" onClick={this.props.profile} width="30px">Profile{"  /"} <disabled className="disabled">Requests</disabled></button> <button><disabled className="disabled">Requests</disabled></button></button>
