...
export default class Edit extends Component {
  ...
  const work = this.state.work;   
    ...
    const res= axios.put("https://localhost:3000/catalog/coach/update/"+this.state.coach.id,coach).then(function (response) {
    ...
    for (let i = 0; i < this.state.experience; i++) {
      experiences.push(<div>
        ...
        <h6 className="">
            Experience name 
            <br></br>
        <input  name="exp" className="form-control" type="text"   onBlur={this.handlenamechange.bind(this)} style={{marginTop: "3px", marginRight: "20px"}}/>
