...
export default class Edit extends Component {
  ...
  render() {
    ...
    for (let i = 0; i < this.state.experience; i++) {
      experiences.push(<Experience addExp={this.add1} />);
    }
    var works = [];
        ...
        >
          ...
          {this.state.coach.acadamicExp.map((exp,index)=>{
           return  <div className="form-inline ">    
             <h6 className="">
                 Experience name 
             <AvField  name="expname" className=""  width="200px" type="textarea" label="" value={exp.className}  style={{marginTop: "3px", marginRight: "20px"}}/>
