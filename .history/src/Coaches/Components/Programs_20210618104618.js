    ...
    render() {
      ...
      { 
        ...
        <td> 
          ...
          <a href={"/client/"+prog.client.id} className="text-secondary" style={{fontWeight: "bold"}} >{prog.client.name} </a>
        ...
        <td>
          {prog.dailyprogram.length == 0 ? <Button color="link"   disabled href={"/tracking/"+prog.id}  className="btn-outline-info" outline>Tracking</Button>}
           <Button color="link"    href={"/tracking/"+prog.id}  className="btn-outline-info" outline>Tracking</Button>
