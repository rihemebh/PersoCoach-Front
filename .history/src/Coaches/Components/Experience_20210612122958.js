...
export default class Experience extends Component {
    ...
    handlechange(event, values){
     var exp = {
         name : values.exp,
         description: values.expdesc,
     }
       console.log( this.props.addExp(exp));
    ...
    render() {
        ...
        return (
            <div>
               ...
               <h6 className="">
                   Experience name 
               <AvField  name="exp" className="" type="text" label=""  onClick={this.handlechange} style={{marginTop: "3px", marginRight: "20px"}}/>
