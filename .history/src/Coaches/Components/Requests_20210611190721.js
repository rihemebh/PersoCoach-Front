...
return rows });
    ...
    return (
     ...
     <br></br>
     <br></br>
     <button className="text-secondary btn btn-link" onClick={this.props.profile} width="30px">Profile{"  /"}</button>
      <button className="disabled text-secondary btn btn-link"><disabled >Requests</disabled></button>
