  ...
  if (this.state.experience > 0 )
    {  experiences = <div>
        ...
        <h6 className="">
            Experience name 
            <br></br>
        <input  name={"exp1"} className="form-control" type="text"   onBlur={this.handlenamechange.bind(this)} style={{marginTop: "3px", marginRight: "20px"}}/>
             ...
             <h6 className=""  >
             Description  <br></br>
               <input  name={"expdesc1"} className="form-control"  type="textarea" label="" 
    ...
    if  this.state.work; i++) {
      works =( <div className="form-inline ">
      <h6 className="">
        Work :
        <AvField
          name={"workname"+i}
