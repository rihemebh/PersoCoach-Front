              ...
              <div className="modal-body text-center">
                  <Container className="rounded border  bg-light shadow">
                      <Row style={{margin: '10px'}}>
                          <Col lg='2' md="2" xs="4"><img classNme="rounded" 
                          src="C:\Users\rihem\Desktop\PersoCoach1\PersoCoach-Front\src\assets\img\clouds.png" alt="user-pic"
                          style={{width:"100px", height: 'auto'}}></img></Col>
                          <Col lg='10' md="10" xs="8">{this.props.reviews.length == 0
