    ...
    render() {
        ...
        return (
            ...
            <div className="topCoaches Container mr-auto" style={{paddingTop: "50px", paddingLeft: "0px"}}>
                ...
                <div className="topcoach "><img className="rounded-circle class="img-circle img-no-padding img-responsive""src={require("assets/img/coach3.jpeg").default} style={picStyle}></img></div>
