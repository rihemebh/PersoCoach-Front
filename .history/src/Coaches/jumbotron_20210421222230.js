...
export default class Jumb extends Component {
    render() {
        ...
        return (
            <Jumbotron className=""style={{ backgroundColor: "white", paddingTop: "0px"}}>
                
            <p style={{color: "#707070" , paddingLeft: "30px" , paddingTop: "0px"  , paddingBottom: "3px"}}> Home / Coaches </p>
           <br></br>
           <Container>   <h2 className="text-center text-info " style={{textShadow: "3px 5px 5px #F9F9F9", fontFamily: "Montsserrat"}}>
            Choose Your New lifestyle
        </h2>
        <br></br>
