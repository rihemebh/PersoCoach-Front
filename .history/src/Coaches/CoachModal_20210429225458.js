...
<Container>
         ...
         <h6></h6> <AvField name="weight" label=" Weight *" type="" required />
         <h6></h6> <AvField name="height" label=" Height *" type="text" required />
         <h6></h6> <AvField name="goal" label=" Goal *" type="textarea" 
          placeholder="Example: I want to change my lifestyle / I want to loose weight ... " 
        
          required />
        <hr></hr>
         
        <h6></h6>   <AvField type="file" name="file" label="Upload a full picture of you" id="exampleFile" />
