...
handleFilter(){
   ...
   _onCheckboxClicked = (i) => {
       ...
       i==1? this.setState({
          ...
          checkedRate1: !this.state.checkedRate1,
        })
         : this.setState({
          checkedRate1: this.state.checkedRate1==true? true : !this.state.checkedRate1 ,
...
let x = this.state.checkedRate;
    ...
    return (
      <div>
        ...
        {this.state.checkedRate.map((value, index) => {
            return <IconCheckbox checked={this.state.checkedRate1} 
        ...
        <IconCheckbox checked={this.state.checkedRate1} 
                      checkedIcon={ <FontAwesome className="fa-star text-warning" name="star" style={style}  />} 
                      uncheckedIcon={ <FontAwesome className="fa-star" name="star" style={style} />}
                      onClick={()=> this._onCheckboxClicked(1)} 
                      />
                      
        <IconCheckbox checked={this.state.checkedRate2} 
                      checkedIcon={ <FontAwesome className="fa-star text-warning" name="star" style={style}  />} 
                      uncheckedIcon={ <FontAwesome className="fa-star" name="star" style={style} />}
                      onClick={()=> this._onCheckboxClicked(2)} 
                      />
                      
        <IconCheckbox checked={this.state.checkedRate3} 
                      checkedIcon={ <FontAwesome className="fa-star text-warning" name="star" style={style}  />} 
                      uncheckedIcon={ <FontAwesome className="fa-star" name="star" style={style} />}
                      onClick={()=> this._onCheckboxClicked(3)} 
                      />
                      
        <IconCheckbox checked={this.state.checkedRate4} 
                      checkedIcon={ <FontAwesome className="fa-star text-warning" name="star" style={style}  />} 
                      uncheckedIcon={ <FontAwesome className="fa-star" name="star" style={style} />}
                      onClick={()=> this._onCheckboxClicked(4)} 
                      />
                      
        <IconCheckbox checked={this.state.checkedRate5} 
                      checkedIcon={ <FontAwesome className="fa-star text-warning" name="star" style={style}  />} 
                      uncheckedIcon={ <FontAwesome className="fa-star" name="star" style={style} />}
                      onClick={()=> this._onCheckboxClicked(5)} 
                      />
{/*
