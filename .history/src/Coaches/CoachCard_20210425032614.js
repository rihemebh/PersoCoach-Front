    ...
    render() {
     ...
     for (let i = 0; i < 5; i++) {
        ...
        return (
         ...
         <CardFooter>
         <CardText><small>{this.props.type} Coach</small></CardText> <a href={'/coach/'+ this.state.id} tag={Link} className="btn-link mr-1 btn text-center text-danger" style={{textDecoration: "underline"}}>
