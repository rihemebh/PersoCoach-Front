  ...
  emptyCoach={
    ...
    constructor(props){
        ...
        this.state = {
            isLoading :true,
            coaches: [],
            nbCoach: collapseTextChangeRangesAcrossMultipleVersions.,
        ...
        return (
            <div className="" style={{}}>
                ...
                <Row className="mr-auto" style={{marginBottom: "20px"}}>
                    ...
                    <Col className="text-center ">Showing 8 of {state.coaches} Coaches</Col>
                    ...
                    <Row>
                     ...
                     {this.state.coaches.map((coach)=>{
                        return  <CoachCard name={coach.name} img=""/>
                      })}
                       </Row>
                       <Row>
                       <Pagin />
