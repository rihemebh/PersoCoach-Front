                ...
                <Row className="mr-auto" style={{marginBottom: "20px"}}>
                    ...
                    <Row>
                     ...
                     {this.state.coaches.map((coach)=>{
                        ...
                        name={coach.name} img="https://ad962edbae8ba7b03b7f-d10007df79b5b7a4e475a291e50a08cf.ssl.cf3.rackcdn.com/bp-coach-sportif/business-plan-coach-sportif.jpg" rate={coach.rate} desc={coach.description}/>
                      })}
                       </Row>
                       <Row>
                       <Pagin />
