...
export default class Jumb extends Component {
    render() {
        ...
        return (
           ...
           <br></br>
           <Container>   <h2 className="text-center text-secondary" style={{textShadow: "3px 5px 5px #F9F9F9"}}>
          Hello PersoCoachers !
        </h2>
        <br></br>
      ...
      <small className="" style={{color: '#d9d9d9'}}>You can search by names , types ..</small>
      </Container>
