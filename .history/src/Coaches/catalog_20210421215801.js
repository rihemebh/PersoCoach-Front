        ...
        return (
            <div className="" style={{backgroundColor: "#F9F9F9"}}>
                ...
                <Row className="mr-auto" style={{marginBottom: "20px"}}>
                    ...
                    <Col className="text-center text-light">Showing 6 of 50 Coaches</Col>
                    <Col className="text-right"><FontAwesome className="fa-list"></FontAwesome><FontAwesome className="fa-table"></FontAwesome></Col>
                </Row>
                    <Row>
                    <CoachCard />
                    <CoachCard />
