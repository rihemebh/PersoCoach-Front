...
<Container>
          ...
          <AvField name="age" label=" Name *" type="" required />
          <AvField name="weight" label=" Name *" type="" required />
          <AvField name="height" label=" Name *" type="" required />
          <AvField name="" label=" Name *" type="" required />
        </AvForm>
              <Form>
