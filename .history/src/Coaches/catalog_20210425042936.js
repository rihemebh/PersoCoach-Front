...
export default class Catalog extends Component {
  emptyCoach={
    ...
    async findCoaches(curr){
      const response= await fetch("catalog/coaches?page="+curr+"&size="+this.state.CoachesPerPage);
    ...
    render() {
    const c =this.state.coaches[0];
    console.log(c.workExp);
        return (
            <div className="" style={{}}>
                <CatalogNav />
                ...
                <Row className="mr-auto" style={{marginBottom: "20px"}}>
                    ...
                    <Col className="text-center ">Showing 8 of {this.state.nbCoach} Coaches</Col>
                    ...
                    <Row>
                     ...
                     {this.state.coaches.map((coach)=>{
                        ...
                        type={coach.type} aexp={coach.acadamicExp[0]} wexp={coach.workExp} />
                      })}
                       </Row>
                       <Row  className="" style={{marginTop: "25px"}}>
                       <Pagination
                        innerClass="pagination-secondary pagination-info pagination"
