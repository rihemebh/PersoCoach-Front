              ...
              <Col xs="9">
                <Row className="mr-auto" style={{ marginBottom: "20px" }}>
                  ...
                  <Col className="text-center ">
                    Showing {this.state.nbCoach > this.state.coaches.length ? 8 : this.state.nbCoach} of{" "}
                    {this.state.filter?this.state.coaches.length:this.state.nbCoach} Coaches
                  </Col>
                  ...
                  <Col>
                    ...
                    <Row className="" style={{ marginTop: "25px" }}>
                      <Pagination
                        ...
                        totalItemsCount={this.state.filter?this.state.coaches.length:this.state.nbCoach}
