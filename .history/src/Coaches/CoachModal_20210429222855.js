...
<Container>
          ...
          <AvField name="height" label=" Height *" type="" required />
          <AvField name="" label=" Goal *" type=""  placeholder="Tell you coach why you want this program ? Example: 
          I want to have a healthy lifestyle / I want to loose weight" required />
        </AvForm>
              <Form>
