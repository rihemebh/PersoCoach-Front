    ...
    return (
      <>
        ...
        <div className="section profile-content">
          ...
          <Container>
            {this.state.prog == true ? <Programs />:
     
              this.state.edit ?  <> <div className="owner">
              <div className="avatar">
                <img
                  alt="..."
                  className="img-circle img-no-padding img-responsive"
            ...
            <div className="name text-center ">
               ...
               First Name & lastname
                ...
                <Button  className="btn-round "  color="danger" outline  style={{fontSize: "10px" , margin: "5px"}}
                 ...
                 <Button  className="btn-round "  color="danger" outline  onClick={this.han} style={{fontSize: "10px" , margin: "5px"}}>
            ...
            : <Requests req={this.reqHandleFalse} requests={this.state.requests} id={this.state.coach.id}/>      } </>}
