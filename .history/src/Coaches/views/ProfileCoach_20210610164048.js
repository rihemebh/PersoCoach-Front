              ...
              <div className="name">
               ...
               First Name & lastname <br />
                ...
                <Container>
                  <Row>
                    <Col></Col>
                  <Col>  <Button  className="btn-round btn-light " style={{fontSize: "11px"}}>
                 <FontAwesome  className="far fa-edit"  color="danger" outline></FontAwesome>Edit Profil</Button></Col>
                  <Col><Button  className="btn-round " color="danger" outline style={{fontSize: "11px"}}>
                 <FontAwesome  className="fas fa-users" ></FontAwesome>Personal Info</Button></Col>
                 <Col><Button  className="btn-round " style={{fontSize: "11px"}}>
                 <FontAwesome  className="fas fa-users"  color="danger" outline ></FontAwesome>Requests</Button></Col>
                 <Col></Col>
                  </Row>
                </Container>
