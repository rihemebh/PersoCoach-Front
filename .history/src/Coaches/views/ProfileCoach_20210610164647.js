              ...
              <div className="name">
               ...
               First Name & lastname <br />
                ...
                <Container>
                  <Row>
                    <Col xs="3"></Col>
                  <Col>  <button  className="btn-round link "   color="" outline style={{fontSize: "11px", margin: "5px"}}>
                 <FontAwesome  className="far fa-edit text-secondary bg-white" ></FontAwesome><span className="text-secondary">Edit Profil</span>
                 </button>
