    ...
    return (
      <>
        ...
        <div className="section profile-content">
          ...
          <Container>
            {this.state.prog == true ? <Programs profile={this.handleProgFalse} />:
     
              this.state.edit ?  
              <Edit profile={this.handelEditF} ></Edit>  : 
              <>
            ...
            : <Requests req={this.reqHandleFalse} coach=requests={this.state.requests} id={this.state.coach.id} profile={this.reqHandleFalse}/>      } </>}
