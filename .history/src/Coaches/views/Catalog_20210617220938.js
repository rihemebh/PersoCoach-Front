...
console.log(error);
  ...
  render() {
    ...
    return (
      <div className="" style={{}}>
        <CatalogNav role={this.state.role} id={this.state.id} />
            ...
            <Row>
              ...
              <Col xs="9">
                <Row className="mr-auto" style={{ marginBottom: "20px" }}>
                  ...
                  Showing   {this.state.role === "ROLE_COACH" ? nb= this.state.nbCoach -1 > 9 ? this.state.coaches.length : this.state.nbCoach -1: nb = this.state.nbCoach}
                   {} of{" "}
                    {nb} Coaches
                  ...
                  <Col>
                    <Row>
                      ...
                      this.state.coaches.map((coach) => {
                       if()
                        if(coach.id != JSON.parse(localStorage.getItem("user")).id)
                        { return (
