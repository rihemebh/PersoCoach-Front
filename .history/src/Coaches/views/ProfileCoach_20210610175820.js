...
class ProfileCoach extends Component {
  ...
  constructor(props) {
    ...
    this.reqHandleFalse = this.reqHandle.bind(this);
  }
  ...
  reqHandleTrue (){
    ...
    this.setState({req : true},()=> console.log(this.state.req));
  }
  reqHandleFalse (){
   
    this.setState({req : false},()=> console.log(this.state.req));
  }
      ...
      <>
        ...
        <div className="section profile-content">
          <Container>
            ...
            : <Requests req={this.reqHandleFalse}/>      }
          </Container>
