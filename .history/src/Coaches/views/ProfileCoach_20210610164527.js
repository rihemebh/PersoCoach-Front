              ...
              <div className="name">
               ...
               First Name & lastname <br />
                ...
                <Container>
                  <Row>
                    <Col xs="3"></Col>
                  <Col>  <Button  className="btn-round btn-light "   color="secondary" outline style={{fontSize: "11px", margin: "5px"}}>
                 <FontAwesome  className="far fa-edit  className="text-secondary"" ></FontAwesome><span className="text-secondary">Edit Profil</span></Button>
