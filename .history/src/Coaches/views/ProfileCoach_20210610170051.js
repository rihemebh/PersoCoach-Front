        ...
        <div className="section profile-content">
          <Container>
            ...
            <Container>
                  ...
                  <Col className="ml-auto mr-auto text-center">  <Button  className="btn-round text-secondary  " outline 
                    color="link"  style={{fontSize: "9px", margin: "5px"}}>
                 <FontAwesome  className="far fa-edit " ></FontAwesome><span >Edit Profil</span></Button>
                  <Button  className="btn-round text-danger" color="danger" outline style={{fontSize: "9px", margin: "5px"}}>
                 <FontAwesome  className="fas fa-lock" ></FontAwesome>Personal Info</Button>
                <Button  className="btn-round text-danger"  color="danger" outline  style={{fontSize: "9px" , margin: "5px", padding :  margin: "5px"}}>
