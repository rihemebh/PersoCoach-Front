              ...
              <div className="name">
               ...
               First Name & lastname <br />
                ...
                <Container>
                  <Row>
                    <Col xs="3"></Col>
                  <Col>  <button  className="btn-round link  bg-white"   color="" outline style={{fontSize: "11px", margin: "5px"}}>
                 <FontAwesome  className="far fa-edit text-secondary" ></FontAwesome><span className="text-secondary">Edit Profil</span>
                 </button>
