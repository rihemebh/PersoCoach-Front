              ...
              <div className="name">
               ...
               First Name & lastname <br />
                ...
                <Container>
                  <Row>
                    <Col xs="3"></Col>
                  <Col>  <Button  className="btn-round btn-light "   color="danger" outline style={{fontSize: "11px"}}>
                 <FontAwesome  className="far fa-edit" ></FontAwesome>Edit Profil</Button>
                  <Button  className="btn-round " color="danger" outline style={{fontSize: "11px"}}>
