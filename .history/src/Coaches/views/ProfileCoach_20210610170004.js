          ...
          <Container>
            ...
            <Container>
                 ...
                 <FontAwesome  className="far fa-edit " ></FontAwesome><span >Edit Profil</span></Button>
                  <Button  className="btn-round  text-secondary " color="danger" outline style={{fontSize: "11px", margin: "5px"}}>
                 <FontAwesome  className="fas fa-lock" ></FontAwesome>Personal Info</Button>
                <Button  className="btn-round text-danger"  color="danger" outline  style={{fontSize: "11px" , margin: "5px"}}>
