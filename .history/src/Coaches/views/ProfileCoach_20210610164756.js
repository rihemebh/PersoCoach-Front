              ...
              <div className="name">
               ...
               First Name & lastname <br />
                ...
                <Container>
                  <Row>
                    <Col xs="3"></Col>
                  <Col>  <Button  className="btn-round  "   color="link"  style={{fontSize: "11px", margin: "5px"}}>
                 <FontAwesome  className="far fa-edit text-secondary" ></FontAwesome><span className="text-secondary">Edit Profil</span></Button>
                  <Button  className="btn-round " color="danger" outline style={{fontSize: "11px", margin: "5px"}}>
                 <FontAwesome  className="fas fa-users" ></FontAwesome>Personal Info</Button>
                <Button  className="btn-round "  color="danger"  style={{fontSize: "11px" , margin: "5px"}}>
