              ...
              <Col xs="9">
                <Row className="mr-auto" style={{ marginBottom: "20px" }}>
                  ...
                  <Col className="text-center ">
                    { JSON.parse(localStorage.getItem("user")).roles[0].name==="ROLE_COACH" ? nb = this.state.nbCoach -1 : nb =this.state.nbCoach }
                    Showing {nb > 9 ? this.state.coaches.length : nb} of{" "}
