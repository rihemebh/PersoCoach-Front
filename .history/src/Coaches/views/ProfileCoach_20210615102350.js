              ...
              {this.state.coach.description}
                ...
                <br />
                  ...
                  <Col className="ml-auto mr-auto text-center" style={{padding :  "10px"}}>  <Button  className="btn-round  " outline 
                    color="danger"  style={{fontSize: "10px", margin: "5px"}} onClick={()=> this.handelEdit(true)}>
                ...
                <Button  className="btn-round "  color="danger" outline  style={{fontSize: "10px" , margin: "5px"}}
                 ...
                 <Button  className="btn-round "  color="default"   onClick={this.handleProg} style={{fontSize: "10px" , margin: "5px"}}>
