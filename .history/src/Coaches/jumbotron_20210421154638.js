    ...
    render() {
        ...
        return (
            ...
            <div className="topCoaches Container mr-auto" style={{paddingTop: "50px", paddingLeft: "0px"}}>
                ...
                <div className="topcoach "><img className="rounded-circle"src={require("public/Coach3.jpeg").default} style={picStyle}></img></div>
                <div className="topcoach "><img className="rounded-circle"src={require("public/Coach.jpeg").default} style={picStyle}></img></div>
                <div className="topcoach"><img className="rounded-circle"src={require("assets/img/Coach2.jpeg").default} style={picStyle}></img></div>
                 </div>
<br></br>
