...
export default class CoachCard extends Component {
    render() {
        return (
            <Col height="100px">
            <Card style={{height: "230px", width:"182px"}} >
         ...
         <FontAwesome className=" fa-star text-light border-dark" style={{textShadow: "3px 5px 5px #F9F9F9"}}></FontAwesome>

         </CardBody>
         <CardFooter> <a href="#" className="btn-link mr-1 btn  text" style={{textDecoration: "underline"}}>See More</a></CardFooter>                     
    </Card>
    </Col>
