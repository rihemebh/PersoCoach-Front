...
export default class Jumb extends Component {
    render() {
        ...
        return (
            <Jumbotron className=""style={{ background: "url(ssets/img/coach3.jpeg)" paddingTop: "0px"}}>
                
            <p style={{color: "#707070" , paddingLeft: "30px" , pa,ddingTop: "0px"  , paddingBottom: "3px"}}> Home / Coaches </p>
           <br></br>
           <Container>   <h2 className="text-center text-info " style={{textShadow: "3px 5px 5px #F9F9F9"}}>
          Hello PersoCoachers !
        </h2>
        <br></br>
