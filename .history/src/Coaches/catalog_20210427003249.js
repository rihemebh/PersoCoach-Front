    ...
    this.setState(
      {
        sortby: "rate",
        direction : d,
        worstclass : 1-this.state.worstclass,
        bestclass : 1-this.state.bestclass,
      },
      () => {
                ...
                <Row className="mr-auto" style={{ marginBottom: "20px" }}>
                  <Col className="text-left">
                    <UncontrolledDropdown>
                      ...
                      >
                        <DropdownItem
                         onClick={(e)=>this.handleSort(0)}>
                         <span  className="dropdown-header" > Best Rated</span>
                        </DropdownItem>
                        <DropdownItem
                          tag="span"
                          onClick={(e)=>this.handleSort(1)}
                        >
                          <span  className="dropdown-header" > Best Rated</span> Worst Rated
                        </DropdownItem>
                        {/*<DropdownItem
                          href="#pablo"
                          onClick={(e) => e.preventDefault()}
