...
*/
  ...
  async findCoaches(curr, d) {
    ...
    this.setState({ coaches: body.content , nbCoach : this.state.coaches.length() });
  }
            ...
            <Row>
              <Col xs="3" style={{ marginTop: "57px" }}>
                ...
                <form onSubmit={this.onClickButton.bind(this)}>
                  ...
                  <FormGroup check>
                    <Label check>
                      <Input defaultValue="" type="checkbox" onClick={()=>this.onClickCheckbox(1)}/>
                      Man <span className="form-check-sign" />
                    </Label>
                  </FormGroup>
                  <FormGroup check>
                    <Label check>
                      <Input defaultValue="" type="checkbox" onClick={()=>this.onClickCheckbox(2)}/>
              ...
              <Col xs="9">
                <Row className="mr-auto" style={{ marginBottom: "20px" }}>
                  ...
                  <Col className="text-center ">
                    Showing {this.state.nbCoach > 8 ? 8 : this.state.nbCoach} of{" "}
