    ...
    render() {
        ...
        return (
            ...
            <div className="topCoaches Container mr-auto" style={{paddingTop: "50px", paddingLeft: "0px"}}>
                <div className="row d-flex justify-content-center mr-auto ml-auto col-sm-3 col-md-2">
                <div className="topcoach "><img className="img-circle img-no-padding img-responsive" src={require("assets/img/coach3.jpeg").default}></img></div>
