...
program.map((prog)=>{
days.push(<>
              <div className="bg-info" style={{height: "50PX", width: "100%" , display:"table"}}>
              <h6 className="text-center text-white  " style={{verticalAlign: "middle", display: "tab"}}>Day {prog.day}</h6>
              </div>
