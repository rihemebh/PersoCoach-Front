...
<Container className="shadow w-75 " style={{borderRadius : "20px 10px 10px 10px"}}>
              <div className="bg-light border-top border-bottom" style={{height: "50PX", width: "100%" , display:"table", backgroundColor : "#abdfed"}}>
              <h6 className="text-center  " style={{verticalAlign: "middle", display: "table-cell"}}>Day {prog.day}</h6>
              </div>
