...
<Col xs="5"></Col>
         <Col xs="3" className="text-center border-top border-bottom" >
   
         <h2 className="text-center" style={{verticalAlign: "middle", display: "table-cell", margin: "50px"}}>Day {prog.day}</h2>
          </Col>
