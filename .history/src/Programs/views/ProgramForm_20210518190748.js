            ...
            <Col className="ml-auto mr-auto" lg="10">
              <Card className="ml-auto mr-auto"  
                ...
                <br></br>
                 ...
                 <DayForm day="1" />
                 <Col sx="9"><Button className="radius btn-round " outline> 
                 <FontAwesome className="fas fa-plus"></FontAwesome>Add another day program</Button></Col>
                 <Row>
                         <Col sx="5"></Col>
                         <Col sx="4"><Button className="radius btn-round " outline> 
                 <FontAwesome className="fas fa-plus"></FontAwesome>Add another day program</Button></Col>
                     </Row>
                 <Container>
                     <Row>
                         <Col></Col>
                         <Col sx="2"><Button className="radius btn-round " outline> 
                 <FontAwesome className="fas fa-plus"></FontAwesome>Add another day program</Button></Col>
                     </Row>
                 </Container>
