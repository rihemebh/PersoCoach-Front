...
<Container className="shadow w-75 " style={{borderRadius : "20px 20px 20px 20px"}}>
              <div className=" border-bottom" style={{height: "50PX", width: "100%" , display:"table"}}>
              <h6 className="text-center display-5 " style={{verticalAlign: "middle", display: "table-cell"}}>Day {prog.day}</h6>
              </div>
