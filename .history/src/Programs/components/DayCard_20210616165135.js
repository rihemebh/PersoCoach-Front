...
handleSave(){
    axios.get("http://localhost:3000/api/program/http://localhost:3000/api/program/60c9fd54e5e59e5991f44925/day/progress?progress=100&day=1/day/progress?progress="+100+"&day="+1)
}
