...
<tbody>
<tr>
    <td><input type="checkbox"  onChange={this.handleCheck.bind(this)}></input> 
    <Button href={"/video/"+this.props.program.videos.fileId} color="link" className="text-danger" > Watch the video</Button> <br/>
