...
<hr></hr>
                ...
                <Row>
                  <Col xs="10" className="text-left">   <h6 className="text-center text-white"><b>Day {this.state.nb}</b> 
                  </h6></Col>
                  {this.state.nb!=1 ?? <Col xs="2"><FontAwesome className="far fa-times-circle" name="clear" onClick={this.clearDay.bind(this)}> </FontAwesome></Col>}
                </Row>
              </Container>
                <br></br>
                <AvForm
