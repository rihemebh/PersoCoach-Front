...
<hr></hr>
                ...
                <Container>
                <Row>
                  <Col xs="10" className="text-left">   <h6 className="text-center text-white"><b>Day {this.props.day}</b> 
                  </h6></Col>
                  <Col xs="2"><FontAwesome className="far fa-times-circle" name="clear" onClick={this.clear day.bind(this)}> </FontAwesome></Col>
                </Row>
              </Container>
                <br></br>
                <AvForm
