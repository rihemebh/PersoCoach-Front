...
<hr></hr>
               ...
               <AvField  name="breakfast"className="col-lg-11" type="" label="" required style={{marginTop: "3px", marginRight: "10px"}}/>
               <AvField  name="breakfast"className="col-lg-11" type="" label=""   style={{marginTop: "3px", marginRight: "10px"}} />
