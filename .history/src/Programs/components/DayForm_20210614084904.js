...
this.setState({nb : this.state.nb + response.data.dailyprogram.length, length : });
...
handleValidSubmit(event,values){
 ...
 axios.put("http://localhost:8080/api/program/"+this.props.id+"/day", dayProgram).then(function (response) {
