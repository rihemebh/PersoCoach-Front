...
export default class DayCard extends Component {
    ...
    render() {
        ...
        <CardBody>
          ...
          this.state.leve <75 ? <Progress color="info" value={this.state.level}></Progress> :
...
<tbody>
<tr>
    <td><input type="checkbox" onClick={this.handleCheck.bind(this)}></input> Breakfast : coffee <br/></td>
</tr>
<tr>
