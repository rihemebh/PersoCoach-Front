...
export default class DayCard extends Component {
    ...
    render() {
        ...
        <CardHeader tag="h6"  className="display-4" >Day {this.props.program.day} </CardHeader>
        <CardBody>
...
<tr>
    <td>
    <input type="checkbox"  onChange={this.handleCheck.bind(this)}></input> Exercices
    <br/>
 <strong style={{fontWeight: "bold"}}>Coach's advice :</strong> <br></br> <span >{this.props.program.activitydesritpion} <br></br></span>
    
    <br/>
    <Button href={"/video/"+this.props.program.videos.fileId} color="danger" outline> Watch the video </Button>
    </td>
</tr>
