...
<hr></hr>
               ...
               <h6 className="text-white">
                   Breakfast
               <AvField  name="breakfast"className="" type="" label="" required style={{marginTop: "3px", marginRight: "10px"}}/>
               <AvField  name="breakfast"className="" type="" label="" required style={{marginTop: "3px", marginRight: "10px"}}/>
               <AvField  name="breakfast"className="" type="" label=""   style={{marginTop: "3px", marginRight: "10px"}} />
                  
                      </h6>

                    <h6 className="text-white"  >
                    Lunch <span className='text-danger'>*</span> 
                      <AvField  name="lunch" className="col-lg-11"  type="textarea" label="" required style={{marginTop: "3px", marginRight: "10px"}} />
                      </h6>
                 
                      <h6 className="text-white"  >
                    Dinner <span className='text-danger'>*</span> 
                      <AvField  name="dinner" className="col-lg-12"  type="textarea" label="" required style={{marginTop: "3px", marginRight: "10px"}} />
                      </h6>
                      </div> 
