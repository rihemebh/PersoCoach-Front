              ...
              {/** <AvField  name="breakfast"className="" type="" label="" required style={{marginTop: "3px", marginRight: "20px"}}/>
               <AvField  name="breakfast"className="" type="" label=""   style={{marginTop: "3px", marginRight: "20px"}} />*/} 
                    ...
                    Lunch <span className='text-danger'>*</span> 
                      <AvField  name="lunch" className="col-lg-12"  type="textarea" label="" required style={{marginTop: "3px", marginRight: "20px"}} />
                      </h6>
                    ...
                    Extra <span className='text-danger'>*</span> 
                      <AvField  name="extra" className="col-lg-12"  type="textarea" label="" required style={{marginTop: "10px", marginRight: "20px"}} />
                      </h6> 
                      <Button className="btn-round" style={{marginTop: "20px",marginLeft: "50px"}} > <FontAwesome className="fas fa-plus"></FontAwesome> </Button>
                      </div> 
                   <br></br>
