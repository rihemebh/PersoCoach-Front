...
<tr>
    <td>
    <Button href={"/video/"+this.props.program.videos.fileId} color="link" className="text-danger" > 
    <input type="checkbox"  onChange={this.handleCheck.bind(this)}></input> Watch the video</Button> <br/>
