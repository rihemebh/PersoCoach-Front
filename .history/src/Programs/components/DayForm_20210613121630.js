...
this.state.nb == 1 ? axios.put("http://localhost:3000/api/program/add", dayProgram).then(function (response) {
  ...
  : axios.put("http://localhost:3000/api/program/"+this.state.id+"/day", detailedProgram).then(function (response) {
    const notify = () => toast.success("Your day program was successfully added !");
    notify();
    var button = document.getElementById(this.state.id);
