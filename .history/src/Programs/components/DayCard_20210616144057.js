...
export default class DayCard extends Component {
    ...
    render() {
        ...
        <CardHeader tag="h6" >Day {this.props.program.day} <Button color="default" outline>Send Your Progress</Button></CardHeader>
        <CardBody>
...
<tr>
    ...
    <br/>
    <Button href={"/video/"+this.props.program.videos.fileId} color="" > Watch the video </Button>
    </td>
</tr>
