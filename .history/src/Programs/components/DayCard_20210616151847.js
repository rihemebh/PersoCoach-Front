...
export default class DayCard extends Component {
    ...
    render() {
        ...
        <CardHeader tag="h6"  className="" >
            <Row><Col className="text-left">Day {this.props.program.day}</Col> 
            
            <Col  className="text-right">
                <Button className="small text-warning" color="link"> <FontAwesome className="fa-check"></FontAwesome> Mark as complete</Button>
               </Col></Row>
             </CardHeader>
        <CardBody>
