               ...
               <Card className="" style={{
                   ...
                   width: "1000px",
                    ...
                    overflowY: "auto"  
                         ...
                         <h6 className="text-center text-white display-4"> Track {this.props.name} 's Progress</h6>
                         <br></br>
        <CardHeader tag="h6" >Day {this.props.program.day}</CardHeader>
        <CardBody>
          <CardTitle  className="" tag="h5">

          <div className="text-center text-white">{this.state.level > 100 ? "You did it !"  : this.state.level +"% Completed"} </div>
          <br/>
...
<tbody>
<tr>
    <td><input type="checkbox"  onChange={this.handleCheck.bind(this)}></input> {this.props.program.restrictions}  <br/></td>
</tr>
