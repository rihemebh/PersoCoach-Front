...
export default class DayCard extends Component {
    ...
    render() {
        ...
        <CardBody>
          ...
          <div className="text-center text-white">{this.state.level = 100 ? "You did it !"  : this.state.level+1 +"% Completed"} </div>
          <br/>
          {this.state.level < 25 ?  <Progress color="danger" value={this.state.level+1}></Progress>:
          this.state.level< 50 ? <Progress color="warning" value={this.state.level+1}></Progress> :
          this.state.level <75 ? <Progress color="info" value={this.state.level+1}></Progress> :
...
<tbody>
<tr>
    <td><input type="checkbox"  onChange={this.handleCheck.bind(this)}></input> <Button color="link" className="text-danger">Watch the video</Button> <br/>
