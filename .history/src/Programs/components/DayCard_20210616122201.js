...
handleUncheck(){
    const level = this.state.level -  12.5 ;
    console.log()
          this.setState({
        level: level      });
}
    ...
    render() {
        ...
        <CardBody>
          ...
          <div className="text-center">{this.state.level} % Completed</div>
          <br/>
...
<tbody>
<tr>
    <td><input type="checkbok" className="form-check-​input"  onChange={this.handleCheck.bind(this)}></input> Breakfast : coffee <br/></td>
</tr>
<tr>
    <td><input type="checko" onChange={this.handleCheck.bind(this)}></input> Lunch : salad <br/></td>
</tr>
<tr>
    <td><input type="radio" onChange={this.handleCheck.bind(this)} ></input> Dinner : Tea <br/></td>
</tr>
<tr>
    <td><input type="radio" onChange={this.handleCheck.bind(this)}></input> Extra : No extra <br/></td>
</tr>
</tbody>
