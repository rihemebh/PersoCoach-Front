...
<hr></hr>
               ...
               <div className="form-inline container-fluid col-lg-12">    
               <h6 className="text-white">
                   Breakfast
               <AvField  name="breakfast"className="col-lg-12" type="textarea" label="" required />
                  
                      </h6>

                    <h6 className="text-white"  >
                    Lunch <span className='text-danger'>*</span> 
                      <AvField  name="lunch" className="col-lg-4"  type="textarea" label="" required />
                      </h6>
                 
                      <h6 className="text-white"  >
                    Dinner <span className='text-danger'>*</span> 
                      <AvField  name="dinner" className="col-lg-4"  type="text" label="" required />
                      </h6>
                      </div> 
