...
export default class ProgramModal extends React.Component {
  ...
  saveRequest =  () => {
    ...
    var prog = {"duration":5, "frequency": 5, "coach": {}, "client": {},
     "type": "keto" , 
     "description": "Eaque possimus fugit ut temporibus. Tenetur sapiente ab et eveniet odit nostrum et. Labore voluptas alias beatae sit eius. Earum omnis mollitia perferendis. Sunt non vel provident eos"}
