...
var detailedProgram = {
        ...
        duration: 0,
        frequency: 0,
        coach: this.props.request.coach,
        client: this.props.request.client,
...
var id;
this.state.nb == 1 ? 
 id = axios.put("http://localhost:3000/api/program/add", detailedProgram).then(function (response) {
    const notify = () => toast.success("Your day program was successfully added !");
    notify();
    var button = document.getElementById(this.state.id);
    this.setState({progId : response.id})
  ...
  : axios.put("http://localhost:3000/api/program/"+this.state.progId+"/day", dayProgram).then(function (response) {
    const notify = () => toast.success("Your day program was successfully added !");
    notify();
    var button = document.getElementById(this.state.id);
