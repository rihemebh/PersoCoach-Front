...
<tr>
    ...
    <br/>
 <strong className="text-info" style={{fontWeight: "bold"}}>Coach's advice :</strong> <br></br> <span  className="text-info" >{this.props.program.activitydesritpion} <br></br></span>
