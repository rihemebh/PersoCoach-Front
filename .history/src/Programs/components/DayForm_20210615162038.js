...
handleValidSubmit(event,values){
 ...
 f.append('video',this.state.video , this.state.video.name )

 const file = new Blob(this.state.video,{type: "application/video"});
 ...
 axios.put("http://localhost:8080/api/program/"+this.props.id+"/day", dayProgram, this.state.video).then(function (response) {
