    ...
    render() {
        ...
        return (
            ...
            <Col  className="text-right">
                <Button className="small text-" color="default" outline> <FontAwesome className="fa-check underline"></FontAwesome>Save your progress</Button>
               </Col></Row>  
        <CardHeader tag="h6"  className="" >Day {this.props.program.day}
             </CardHeader>
        <CardBody>
...
<tr>
    ...
    <br/>
    <VideoPlayer videoId={this.props.program.videos.fileId} description={this.props.program.activitydesritpion} ></VideoPlayer>
    </td>
</tr>
