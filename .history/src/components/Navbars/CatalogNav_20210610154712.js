        ...
        >
          ...
          <NavItem>
            ...
            {authenticated ?  
              <>
                <NavItem >
                 <NavLink  className="text-danger" onClick={onSignOut}>
                    <FontAwesome className="fas fa-sign-out" />Logout
                  </NavLink>
                </NavItem>
                ...
                <NavLink className=""
                  onClick={ () => {history.push({pathname: '/client-profile'})} }>
                    <FontAwesome className="far fa-user" />Profile
                  </NavLink>
                </NavItem>
              </>
            : 
              ...
              <NavItem>
                  ...
                  <Button className="btn-round" color="infooutline type="button">
