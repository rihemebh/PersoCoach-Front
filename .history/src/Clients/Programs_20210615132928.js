...
import ReviewModal from 'Coaches/Components/ReviewModal';
...
export default class Programs extends Component {
    constructor(props){
       ...
       componentDidMount() {
        ...
        axios.get("http://localhost:8080/api/programs/"+this.state.currentUserInfo.id).then(function (response) {
     ...
     programs.forEach((prog)=>
      { 
        ...
        <td> 
          ...
          <a href={"/coach/"+prog.coach.id} style={{fontWeight: "bold"}}  >{prog.coach.name} </a>
        ...
        <td>
           <ReviewModal />
            <Button color="link"  href={"/tracking/"+prog.id}  className="btn-outline-info" outline>
