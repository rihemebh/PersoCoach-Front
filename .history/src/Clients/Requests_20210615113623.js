...
export default class Requests extends Component {
  ...
  componentDidMount() {
    ...
    axios.get("http://localhost:8080/api/client/"+currentUserInfo.id+"/requests").then(function (response) {
...
axios.put("http://localhost:8080/api/bprogram/"+id+"/response",rep).then(function (response) {
