...
axios.put("http://localhost:8080/api/bprogram/60c5d8fb96b38d7cba0ab78d/response")
      ...
      rows.push(
        <tr>
          ...
          {request.status == "pending" ? (
            ...
            <>
              <td className="text-warning"> <Button color="link" className="text-success border-bottom"
               onClick={()=>this.handleResponse("accepted")}>Accept</Button>
              or<Button color="link "  className="text-danger border-bottom"
              onClick={()=>this.handleResponse("refused")}
              >Refuse</Button></td>
              <td>
