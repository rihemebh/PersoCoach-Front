      ...
      rows.push(
        <tr>
          ...
          {request.status == "pending" ? (
            ...
            <>
              <td className="text-warning"> <Button color="link" className="text-success border-bottom">Accept</Button>
              or<Button color="link "  className="text-success border-bottom">Refuse</Button></td>
              <td>
