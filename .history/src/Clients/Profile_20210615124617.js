        ...
        <div className="section profile-content">
          <Container>
            <div className="owner">
              ...
              <div className="name">
                <h4 className="">{this.state.currentUserInfo.name} </h4>
              ...
              <>
                <Row>
                  <Col className=" text-center">
                    ...
                    <br />
                      ...
                      <Row className="ml-auto mr-auto text-center" style={{padding :  "10px"}}>
                        <Col className="ml-auto mr-auto text-center" style={{padding :  "10px"}}>
                        ...
                        >
                          <FontAwesome className="fas fa-align-justify"></FontAwesome>{" "}
                          Programs
                        </Button>
                        </Col>
                ...
                <div className="nav-tabs-navigation">
                  ...
                  <h5 style={{ fontWeight: "bold" }}>
                    Get a closer look at your program requests sent to Coaches :{" "}
                  </h5>
                </div>

                <Requests
                  client={this.state.currentUserInfo}
                  programs={this.handleProgram.bind(this)}
                />
              </>
            ) : (
              <>
                <Programs
                  profile={this.handleProgram.bind(this)}
                  client={this.state.currentUserInfo}
                />
              </>
            )}
