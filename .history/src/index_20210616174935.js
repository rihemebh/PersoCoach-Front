...
import ProfileCoach from "Coaches/views/ProfileCoach";
import RegisterPage from "Authentification/RegisterPage";
import Test from "Programs/views/test";
import ProgramForm from "Programs/views/ProgramForm";
import Tracking from "Programs/views/Tracking";
import Track from "Programs/views/Track";
import TrackingCoach from "Programs/views/TrackingCoach";
import ClientRequests from "Clients/ClientRequests"
import VideoPlayer from "Programs/components/VideoPlayer"
 ...
 <Route
    ...
    />
      ...
      />
        ...
        render={(props) => <ProfileCoach {...props} />}
      />  
...
<Route
        path="/track/:id"
        render={(props) => <TrackingCoach {...props} />}
      />
      <Route
