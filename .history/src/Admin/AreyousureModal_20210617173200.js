...
export default class Areyousure extends React.Component {
  ...
  deleteCoach() {
    ...
    if(this.props.coach == true ){
    ...
    }else if(this.props.review == false){
        axios
        .delete(
        ...
        axios
        .delete(
          "http://localhost:8080/catalog/coach/review/delete/" + this.props.user.id
        )
        .then((response) => {
          console.log(response.data);
          window.location.reload();
          ...
          <Col>
            ...
            >
              <div className="modal-header">
                ...
                <br></br>
                Warning: All the information will be permanently deleted, you will not be able to revover it 
              </div>
