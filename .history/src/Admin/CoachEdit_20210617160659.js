...
export default class Edit extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      gender: this.props.coach.gender,
      pass : false,
    };
  ...
  handleValidSubmit(event, values) {
    ...
    const username = this.state.coach.username;
    let pass;
    ...
    axios
      .put(
        "http://localhost:8080/catalog/coach/update/" + this.state.coach.id,
        {
          email: values.email,
          username: username,
          password: pass,
  ...
  render() {
    ...
    return (
      <>
        ...
        >
          <h4 className="text-center">Update {this.props.coach.name}'s Profile </h4>
          <hr></hr>
          <div className="form-inline ">
            <h6 className="">
              Email
            ...
            {this.state.pass == true ?    <>        <h6 className="">
              Password
              <AvField
                name="pass"
                className=""
            ...
            <h6><Button color="link" className="text-danger" onClick={this.changePass.bind(this)}>Clear</Button></h6>
            </>
            : <div>
              ...
              <h6>
                ...
                >
                  <option value="none" hidden>
                    {this.state.gender == "Man" ? "Male" : "Female"}
                  </option>
          ...
          {this.state.works.map((exp, index) => {
            return (
              <div className="form-inline ">
                ...
                <Button
                  color="link"
                  onClick={() => this.handleDeletework(exp.id)}
                >
                  <FontAwesome className="fa-minus-square"></FontAwesome>
                </Button>
              </div>
