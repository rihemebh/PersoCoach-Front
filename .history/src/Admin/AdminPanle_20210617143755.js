                      ...
                      this.state.clients.map((coach) => {
                        return (
                          <tr>
                            ...
                            <td>{coach.name}</td>
                            <td>{coach.email}</td>
                            <td style={{width: "100%"}}>{coach.description}</td>
                      ...
                      this.state.reviews.map((review) => {
                        return (
                          <tr>
                            ...
                            <td>
                              <a href={"/client/"+review.client.id} >{review.client.name}</a>
                              </td>
                            <td style={{width: "100%"}}>{review.coach.id}</td>
                     <td>{review.coach.name}</td>
                     <td>{review.rate}</td>
                     <td>{review.text}</td>
                     <td>{review.date}</td>
