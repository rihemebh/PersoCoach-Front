...
export default class Areyousure extends React.Component {
  ...
  deleteCoach(){
    axios.delete("http://localhost:8080/catalog/coach/delete/"+this.props.user.id)
    .then((response) => {
      ...
      <Container>
        ...
        <Row id="modals">
          <Col>
            ...
            {/* Modal */}
            <Modal  className="" isOpen={this.state.modal} toggle={this.toggleModal}>
             ...
             Are you sure you want to delete this user ?      
              ...
              <div className="modal-footer"
               >
                  ...
                  <Button Color="default" onClick={()=>this.deleteCoach()}>YES delete it! </Button>
