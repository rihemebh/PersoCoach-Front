  ...
  render() {
    return (
      <>
        ...
        <br />
        <NavItem className="text-center ">
              <a href="/index" tag={Link} className="text-secondary" style={{marginBottom: "20px"}} >
           <h6>Home</h6> 
              </a>
            </NavItem>
            
            <NavItem className="text-center ">
              <a href="/Coaches" tag={Link} className="text-secondary"  style={{marginBottom: "10px"}} >
           <h6>Catalog</h6> 
              </a>
            </NavItem>
            <NavItem className="text-center ">
