  ...
  render() {
    return (
      <>
        ...
        <br />
        <NavItem className="text-center ">
              <NavLink to="/index" tag={Link} className="text-secondary" >
           <h6>Home</h6> 
              </NavLink>
            </NavItem>
            <NavItem className="text-center ">
              <NavLink to="/Coaches" tag={Link} className="text-secondary" >
           <h6>Catalog</h6> 
              </NavLink>
            </NavItem>
            <NavItem className="text-center ">
              <NavLink  className="text-secondary" onClick={this.addCoach()}>
           <h6>Add a Coach</h6> 
              </NavLink>
            </NavItem>
