...
export default class AdminPanel extends Component {
  constructor(props) {
    ...
    this.handleSearchCoaches = this.handleSearchCoaches.bind(thi)
  }


handleSearchCoaches(e){
    ...
    return (
      <Row>
        <Col xs="3" style={{ backgroundColor: "#D5EDF2", height: "auto" , minHeight : "700px"}}>
          ...
          <br></br>
          <NavItem className="text-center ">
            <Button className="btn-round btn-danger" type="button" onClick={this.onSignOut}>
                ...
                >
                  <thead>
                    <tr>
                      ...
                      <th>Gender</th>
                      <th>rate</th>
                      <th><span className="text-white">..........</span>Description<span className="text-white">..........</span></th>
                        ...
                        return (
                          <tr>
                            ...
                            <td>
                              ...
                              onClick={()=> this.setState({coach: false, review: false, clien : false , editCoach : true, toedit : coach })}
                              >
                                {" "}
                                <FontAwesome
                            ...
                            <td>
                           <Areyousure user={coach} coach={true} review={false}/>
                      ...
                      this.state.clients.map((coach) => {
                        return (
                          <tr>
                            ...
                            <td>
                             <Areyousure user={coach} coach={false} review={false} />
                            </td>
                          </tr>
                        );
                      })
                  ...
                  <tbody>
                    {this.state.loading == false ? (
                     ...
                     <td>{review.date}</td>
                            ...
                            <td>
                          <Areyousure user={review.id} coach={false} review={true}></Areyousure>
                            </td>
                          </tr>
                        );
                      })
