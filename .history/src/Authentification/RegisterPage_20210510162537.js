...
import { Button, Card, Form, Input, Container, Row, Col, NavbarBrand } from "reactstrap";
...
function RegisterPage() {
  ...
  padding: "30px" }}>
                ...
                <div className="forgot">
                  ...
                  >
                    Already a member? <NavbarBrand href='/login'  tag={Link} className='link' style={{textDecoration:"underline"}}>Sign in</a>
                  </Button>
                </div>
              </Card>
            </Col>
