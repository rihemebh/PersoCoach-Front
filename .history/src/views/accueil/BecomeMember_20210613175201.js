...
const BecomeMember = () =>{
    return(
        ...
        <Row >
            <Col>
            <img src="https://i.pinimg.com/564x/6f/ab/f1/6fabf16b1ce45c39fa3a796032ac967c.jpg?fbclid=IwAR2sk95NkyWVo69UitOplMIs2p5sNxCZHhP3f2A8CFJ39sYrRRrt1flYexA" alt="pic" style={{width:'800px', height:'300px'}} />
        </Col>
        <Col>
