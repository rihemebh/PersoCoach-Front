          ...
          <NavItem>
            ...
            {authenticated ?  
              <>
                ...
                <NavItem>
                  {props.role=="ROLE_ADMIN"? <><Button className="btn-round btn-danger"  type="button" 
                onClick={ () => {history.push({pathname: '/adminpanel'})} }>
                  Admin Panel
                </Button></> : props.role=="ROLE_COACH"?  
                <Button className="btn-round btn-danger"  type="button" 
                onClick={ () => {history.push({pathname: '/coach-profile/'+props.id})} }>
                  <FontAwesome className="fas fa-user" />Profile
                </Button>:<Button className="btn-round btn-danger"  type="button" 
                ...
                <NavItem>
                 <Button className="btn-round btn-outline-danger"  type="button" onClick={onSignOut}>
            ...
            : 
              ...
              <NavItem>
                <a href="/login">
                  <Button className="btn-round btn-outline-danger" outline type="button">
